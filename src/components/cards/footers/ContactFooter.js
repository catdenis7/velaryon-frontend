...
import { BsFillCalendarFill, BsPlusCircleFill } from "react-icons/bs";
      ...
      <div style={{ display: "flex" }}>
        <div>
          ...
          <small style={{ color: "black" }}>
            Fecha de Contacto:{" "}
            {new Date(data.last_contact).toLocaleString() ?? "N/A"}
          </small>
          <br></br>
          <MdExposurePlus1 color={"#406e73"} style={{ marginRight: 5 }} />
          <small style={{ color: "black" }}>
            Veces Contactadas: {data.contact_count}
          </small>{" "}
          <br></br>
          <Link to={id}>
            <button
