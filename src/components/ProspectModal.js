                        ...
                        <div className="modal-body">
                            <div className='row'>
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control"
                                        ...
                                        id="exampleInputEmail1" aria-describedby="name"></input>
                                </div>
                            </div>
                            <div className='row'>
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control"
                                        ...
                                        id="exampleInputEmail1" aria-describedby="lastName"></input>
                                </div>
                            </div>
                            <div className='row'>
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control"
                                        ...
                                        id="exampleInputEmail1" aria-describedby="phoneNumber"></input>
                                </div>
                            </div>
                            <div className='row'>
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control"
                                        ...
                                        id="exampleInputEmail1" aria-describedby="email"></input>
                                </div>
                            </div>
                            ...
                            <div className="row" style={{ color: "#406e73", display: 'flex', margin: "20px" }}>
                                <div style={{ display: 'flex' }}>
                                    ...
                                    <select className="form-select" value={this.state.contactMethod}
